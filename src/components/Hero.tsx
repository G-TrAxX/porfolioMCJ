        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              ...
              <span className="text-sm text-gray-300">Maison Concepts et Joaillerie d'Art</span>
            </motion.div>
            ...
            <div className="space-y-4">
              ...
              >
                <span className="bg-gradient-to-r from-white via-rose-300 to-amber-300 bg-clip-text text-transparent">
            ...
            >
              {achievements.map((achievement, index) => (
                ...
                >
                  <achievement.icon className="h-8 w-8 text-rose-400 mx-auto mb-2" />
            ...
            >
              <motion.button
                ...
                className="bg-gradient-to-r from-rose-500 to-amber-500 text-white px-8 py-4 rounded-full font-semibold shadow-lg hover:shadow-xl transition-all duration-300"
              >
          ...
          >
            <div className="relative">
              <motion.div
                ...
                className="absolute inset-0 bg-gradient-to-r from-rose-400 to-amber-400 rounded-full blur-3xl opacity-20"
              />
              
              <motion.div
                whileHover={{ scale: 1.02 }}
                className="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-8 overflow-hidden"
              >
                ...
                <motion.div
                  ...
                  className="absolute top-4 right-4 bg-rose-400/20 backdrop-blur-sm rounded-full p-3"
                >
