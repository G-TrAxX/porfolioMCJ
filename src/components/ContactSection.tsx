        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          >
            <div className="space-y-6">
              {contactInfo.map((info, index) => (
                <motion.a
                  ...
                  className="flex items-center space-x-4 p-6 bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl hover:border-rose-400/30 hover:bg-white/10 transition-all duration-300 group"
                >
                  <div className="w-14 h-14 bg-gradient-to-br from-rose-400/20 to-amber-400/20 backdrop-blur-sm border border-white/10 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                    <info.icon className="h-6 w-6 text-rose-400" />
                  </div>
                  
                  <div>
                    <div className="text-sm text-gray-400 mb-1">{info.label}</div>
                    <div className="text-white font-medium group-hover:text-rose-400 transition-colors duration-300">
                      {info.value}
                    </div>
                  </div>
                </motion.a>
            ...
            <motion.div
              ...
              className="space-y-4"
            >
              <h3 className="text-xl font-semibold text-white mb-4">Navigation rapide</h3>
              <div className="flex flex-wrap gap-3">
                {[
                  ...
                  <motion.button
                    ...
                    className="px-4 py-2 bg-white/10 backdrop-blur-sm border border-white/20 text-gray-300 rounded-lg hover:bg-rose-400/20 hover:border-rose-400/30 hover:text-rose-400 transition-all duration-300"
                  >
                    {item.label}
                  </motion.button>
                ))}
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-white/5 backdrop-blur-sm border border-white/10 rounded-lg text-white placeholder-gray-400 focus:border-rose-400/50 focus:ring-1 focus:ring-rose-400/50 focus:outline-none transition-all duration-300"
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-3 bg-white/5 backdrop-blur-sm border border-white/10 rounded-lg text-white focus:border-rose-400/50 focus:ring-1 focus:ring-rose-400/50 focus:outline-none transition-all duration-300"
                >
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 bg-white/5 backdrop-blur-sm border border-white/10 rounded-lg text-white placeholder-gray-400 focus:border-rose-400/50 focus:ring-1 focus:ring-rose-400/50 focus:outline-none transition-all duration-300 resize-none"
              ...
              <motion.button
                ...
                className="w-full bg-gradient-to-r from-rose-500 to-amber-500 text-white px-8 py-4 rounded-lg font-semibold shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 flex items-center justify-center space-x-2"
              >
                {isSubmitting ? (
                  <>
                    <motion.div
